...
class MLPQlearning():
	...
	def __init__ (self, checkpoint_path = "CONV_Q_LEARNING"):
		...
		self._saver = tf.train.Saver()
                ...
                new_saver = tf.train.import_meta_graph('CONV_Q_LEARNING-260000.meta')
	...
	def get_frame(self,input_screen, reward):
		...
		#print "Status: %s, time: %s, random action: %s, reward %s" % (stt,self._time, self._probability_random_action, reward)
                if reward !=0:
                    print reward
